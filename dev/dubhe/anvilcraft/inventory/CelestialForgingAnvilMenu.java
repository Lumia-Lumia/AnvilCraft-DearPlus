...
public class CelestialForgingAnvilMenu extends AbstractContainerMenu {
    ...
    public CelestialForgingAnvilMenu(@Nullable MenuType<?> menuType, int containerId, Inventory inventory, CelestialForgingAnvilBlockEntity blockEntity) {
    ...
    public CelestialForgingAnvilMenu(@Nullable MenuType<?> menuType, int containerId, Inventory inventory, FriendlyByteBuf extraData) {
        this(menuType, containerId, inventory, (CelestialForgingAnvilBlockEntity) Objects.requireNonNull(inventory.player.level().getBlockEntity(extraData.readBlockPos())));
    }
    ...
    private static final Item[] ANVIL_ITEMS = {ModBlocks.CONFINED_TIME_ANVILON.asItem(), ModBlocks.CONFINED_SPACE_ANVILON.asItem(), ModBlocks.CONFINED_MASS_ANVILON.asItem(), ModBlocks.CONFINED_ENERGY_ANVILON.asItem()};
    ...
    private void handleAnvilTransfer(int slot, boolean add) {
        ...
        if (add) {
            ...
            for (int i = this.slots.size() - 1; i >= MATERIAL_SLOT + 1; i--) {
                ...
                if (ItemStack.isSameItemSameComponents(invStack, toMove) && invStack.getCount() < invStack.getMaxStackSize()) {
                    invStack.grow(1);
                    targetSlot.remove(1);
                    invSlot.setChanged();
                    targetSlot.setChanged();
    ...
    public boolean stillValid(Player player) {
        ...
        return stillValid(ContainerLevelAccess.create(this.blockEntity.getLevel(), blockEntity.getBlockPos()), player, ModBlocks.CELESTIAL_FORGING_ANVIL.get());
    }

    /// === 预计算显示表（匹配用户预设，1–64 砧子数量） ===
    /// 年龄：27 My + 30 By + 7 Ty
    private static final String[] AGE_TABLE = {"2 My", "2.52 My", "3.18 My", "4 My", "5.04 My", "6.35 My", "8 My", "10.1 My", "12.7 My", "16 My", "20.2 My", "25.4 My", "32 My", "40.3 My", "50.8 My", "64 My", "80.6 My", "102 My", "128 My", "161 My", "203 My", "256 My", "323 My", "406 My", "512 My", "645 My", "813 My", "1 By", "1.26 By", "1.59 By", "2 By", "2.52 By", "3.18 By", "4 By", "5.04 By", "6.335 By", "8 By", "10.1 By", "12.7 By", "16 By", "20.2 By", "25.4 By", "32 By", "40.3 By", "50.8 By", "64 By", "80.6 By", "102 By", "128 By", "161 By", "203 By", "256 By", "323 By", "406 By", "512 By", "645 By", "813 By", "1 Ty", "1.26 Ty", "1.59 Ty", "2 Ty", "2.52 Ty", "3.18 Ty", "4 Ty"};
    /// 半径：20 R⊕ + 44 R☉
    private static final String[] RADIUS_TABLE = {"0.125 R⊕", "0.158 R⊕", "0.198 R⊕", "0.25 R⊕", "0.32 R⊕", "0.4 R⊕", "0.5 R⊕", "0.63 R⊕", "0.79 R⊕", "1 R⊕", "1.26 R⊕", "1.59 R⊕", "2 R⊕", "2.52 R⊕", "3.18 R⊕", "4 R⊕", "5.04 R⊕", "6.35 R⊕", "8 R⊕", "10.1 R⊕", "0.125 R☉", "0.158 R☉", "0.198 R☉", "0.25 R☉", "0.32 R☉", "0.4 R☉", "0.5 R☉", "0.63 R☉", "0.79 R☉", "1 R☉", "1.26 R☉", "1.59 R☉", "2 R☉", "2.52 R☉", "3.18 R☉", "4 R☉", "5.04 R☉", "6.35 R☉", "8 R☉", "10.1 R☉", "12.7 R☉", "16 R☉", "20.2 R☉", "25.4 R☉", "32 R☉", "40.3 R☉", "50.8 R☉", "64 R☉", "80.6 R☉", "102 R☉", "128 R☉", "161 R☉", "203 R☉", "256 R☉", "323 R☉", "406 R☉", "512 R☉", "645 R☉", "813 R☉", "1k R☉", "1.26k R☉", "1.59k R☉", "2k R☉", "2.52k R☉"};
    /// 质量：40 M⊕ + 24 M☉
    private static final String[] MASS_TABLE = {"0.022 M⊕", "0.031 M⊕", "0.044 M⊕", "0.063 M⊕", "0.088 M⊕", "0.125 M⊕", "0.177 M⊕", "0.25 M⊕", "0.35 M⊕", "0.5 M⊕", "0.7 M⊕", "1 M⊕", "1.41 M⊕", "2 M⊕", "2.82 M⊕", "4 M⊕", "5.66 M⊕", "8 M⊕", "11.3 M⊕", "16 M⊕", "22.6 M⊕", "32 M⊕", "45.3 M⊕", "64 M⊕", "90.5 M⊕", "128 M⊕", "181 M⊕", "256 M⊕", "362 M⊕", "512 M⊕", "724 M⊕", "1k M⊕", "1.41k M⊕", "2k M⊕", "2.82k M⊕", "4k M⊕", "5.66k M⊕", "8k M⊕", "11.3k M⊕", "16k M⊕", "0.063 M☉", "0.088 M☉", "0.125 M☉", "0.177 M☉", "0.25 M☉", "0.35 M☉", "0.5 M☉", "0.7 M☉", "1 M☉", "1.41 M☉", "2 M☉", "2.82 M☉", "4 M☉", "5.66 M☉", "8 M☉", "11.3 M☉", "16 M☉", "22.6 M☉", "32 M☉", "45.3 M☉", "64 M☉", "90.5 M☉", "128 M☉", "181 M☉"};
    /// 温度：24 ℃ + 40 K
    private static final String[] TEMPERATURE_TABLE = {"-223 ℃", "-217 ℃", "-210 ℃", "-202 ℃", "-194 ℃", "-184 ℃", "-173 ℃", "-161 ℃", "-147 ℃", "-132 ℃", "-114 ℃", "-95 ℃", "-73 ℃", "-49 ℃", "-21 ℃", "10 ℃", "44 ℃", "83 ℃", "127 ℃", "176 ℃", "231 ℃", "293 ℃", "362 ℃", "440 ℃", "800 K", "898 K", "1010 K", "1130 K", "1270 K", "1430 K", "1600 K", "1800 K", "2020 K", "2260 K", "2540 K", "2850 K", "3200 K", "3590 K", "4030 K", "4530 K", "5080 K", "5700 K", "6400 K", "7180 K", "8060 K", "9050 K", "10200 K", "11400 K", "12800 K", "14400 K", "16100 K", "18100 K", "20300 K", "22800 K", "25600 K", "28700 K", "32300 K", "36200 K", "40600 K", "45600 K", "51200 K", "57500 K", "64500 K", "72400 K"};
    ...
    public CelestialForgingAnvilBlockEntity getBlockEntity() {
