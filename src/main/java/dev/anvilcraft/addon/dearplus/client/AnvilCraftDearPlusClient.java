package dev.anvilcraft.addon.dearplus.client;
...
@Mod(value = AnvilCraftDearPlus.MOD_ID, dist = Dist.CLIENT)
public class AnvilCraftDearPlusClient {
    public AnvilCraftDearPlusClient(IEventBus modBus, ModContainer container) {
