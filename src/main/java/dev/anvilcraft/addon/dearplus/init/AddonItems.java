...
import dev.anvilcraft.addon.dearplus.item.AutumniumResonatorItem;
    ...
    public static final ItemEntry<AutumniumResonatorItem> AUTUMNIUM_RESONATOR = REGISTRUM
        ...
        .recipe((ctx, prov) -> {
            ...
            ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.getEntry())
                ...
                .save(prov, AnvilCraftDearPlus.of("autumnium_resonator_repair"));
        })
        .register();
        ...
        .recipe((ctx, prov) -> {
            ...
            ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.getEntry())
                ...
                .unlockedBy("has_autumnium_ionocraft",
                    RegistrumRecipeProvider.has(ctx.getEntry()))
                .save(prov, AnvilCraftDearPlus.of("autumnium_ionocraft_repair"));
        })
        .register();
