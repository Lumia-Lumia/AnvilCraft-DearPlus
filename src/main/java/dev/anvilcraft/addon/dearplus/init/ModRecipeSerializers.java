...
import dev.anvilcraft.addon.dearplus.recipe.AutumniumHeatingRecipe;
import dev.anvilcraft.addon.dearplus.recipe.RingedAutumniumBroadswordCraftingRecipe;
import dev.anvilcraft.addon.dearplus.recipe.RingedAutumniumBroadswordRepairRecipe;
import dev.anvilcraft.addon.dearplus.recipe.AutumniumStampingRecipe;
...
public class ModRecipeSerializers {
    private static final DeferredRegister<RecipeSerializer<?>> DR = DeferredRegister.create(
        Registries.RECIPE_SERIALIZER, AnvilCraftDearPlus.MOD_ID
    );
