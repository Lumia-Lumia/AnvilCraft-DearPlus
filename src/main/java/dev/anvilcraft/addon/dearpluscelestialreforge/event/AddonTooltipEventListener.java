...
import dev.anvilcraft.addon.dearpluscelestialreforge.recipe.data.VyingMergeData;
import dev.anvilcraft.addon.dearpluscelestialreforge.util.AffixNumberFormat;
...
public class AddonTooltipEventListener {
    public static final String AFFIX_TRANQUIL = "affix.anvilcraft_dearpluscelestialreforge.tranquil";
    public static final String AFFIX_VYING = "affix.anvilcraft_dearpluscelestialreforge.vying";
    public static final String AFFIX_CHOPPER = "affix.anvilcraft_dearpluscelestialreforge.chopper";
    public static final String AFFIX_DECAPITATOR = "affix.anvilcraft_dearpluscelestialreforge.decapitator";
    public static final String AFFIX_DISSPOSSESSOR = "affix.anvilcraft_dearpluscelestialreforge.dispossessor";
