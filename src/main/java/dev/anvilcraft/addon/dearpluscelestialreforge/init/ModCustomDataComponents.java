...
import dev.anvilcraft.addon.dearpluscelestialreforge.recipe.data.BladeAffixesData;
import dev.anvilcraft.addon.dearpluscelestialreforge.recipe.data.DoubleBladeAffixesData;
import dev.anvilcraft.addon.dearpluscelestialreforge.recipe.data.EnchantmentMaxMergeData;
import dev.anvilcraft.addon.dearpluscelestialreforge.recipe.data.EternalMergeData;
import dev.anvilcraft.addon.dearpluscelestialreforge.recipe.data.TranquilToEnchantmentsData;
...
public class ModCustomDataComponents {
    private static final DeferredRegister<ICustomDataComponent.Type<?>> DF = DeferredRegister.create(
        ModRegistries.CUSTOM_DATA_TYPE_KEY, AnvilCraftDearPlusCelestialReforge.MOD_ID
    );
